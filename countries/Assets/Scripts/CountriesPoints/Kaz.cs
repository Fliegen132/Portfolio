...
public class Kaz : MonoBehaviour
{
    [SerializeField]
    Rigidbody2D rb;
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        if (collision.gameObject.CompareTag("Block"))
        {
            ...
            rb.velocity = new Vector2(Random.Range(-2f, 2f), Random.Range(-2f, 2f));
            collision.gameObject.layer = LayerMask.NameToLayer("KzZone");
            collision.gameObject.GetComponent<Renderer>().material.color = new Color(0, 1, 0, 1);
        }
